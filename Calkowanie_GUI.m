function varargout = Calkowanie_GUI(varargin)
% DO NOT EDIT
% wygenerowane automatycznie przy tworzeniu GUI
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Calkowanie_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @Calkowanie_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Calkowanie_GUI is made visible.
function Calkowanie_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = Calkowanie_GUI_OutputFcn(hObject, eventdata, handles) 
