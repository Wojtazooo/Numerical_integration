function varargout = Numerical_Integration_GUI(varargin)
% DO NOT EDIT
% wygenerowane automatycznie przy tworzeniu GUI
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Numerical_Integration_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @Numerical_Integration_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Numerical_Integration_GUI is made visible.
function Numerical_Integration_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = Numerical_Integration_GUI_OutputFcn(hObject, eventdata, handles) 
...
xlabel('x')
ylabel('y')
legend('Midpoint rule','graph f(x)')
title('Midpoint rule')
...
xlabel('x')
ylabel('y')
legend('Trapezoidal rule','graph f(x)')
